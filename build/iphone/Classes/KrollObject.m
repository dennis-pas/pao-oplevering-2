...
//@interface paoapp2Object : NSObject
//@end

@interface paoapp2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[paoapp2Object class]])
		{
			for (NSString *key in [[(paoapp2Object*)o modules] allKeys])
			{
