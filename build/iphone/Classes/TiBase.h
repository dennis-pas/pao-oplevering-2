...
// in simulator we redefine to format for paoapp2 Developer console
...
{\
	NSString * exceptionName = [@"org.paoapp2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.paoapp2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIpaoapp2NativeItemNone = -1, 
	UIpaoapp2NativeItemSpinner = -2,
	UIpaoapp2NativeItemProgressBar = -3,
	
	UIpaoapp2NativeItemSlider = -4,
	UIpaoapp2NativeItemSwitch = -5,
	UIpaoapp2NativeItemMultiButton = -6,
	UIpaoapp2NativeItemSegmented = -7,
	
	UIpaoapp2NativeItemTextView = -8,
	UIpaoapp2NativeItemTextField = -9,
	UIpaoapp2NativeItemSearchBar = -10,
	
	UIpaoapp2NativeItemPicker = -11,
	UIpaoapp2NativeItemDatePicker = -12,
	
	UIpaoapp2NativeItemInfoLight = -13,
	UIpaoapp2NativeItemInfoDark = -14,
	
	UIpaoapp2NativeItemDisclosure = -15,
	
	UIpaoapp2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all paoapp2 instances of
