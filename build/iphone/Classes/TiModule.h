...
/**
 The base class for all paoapp2 modules
 */
...
/**
 paoapp2 Platform calls this method on startup.
 */
-(void)startup;

/**
 paoapp2 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 paoapp2 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 paoapp2 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 paoapp2 Platform calls this method on resume.
 @param sender The sender of the event.
 */
