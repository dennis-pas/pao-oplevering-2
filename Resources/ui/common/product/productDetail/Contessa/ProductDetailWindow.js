...
function ProductDetailWindow() {
	...
	var ProductDetailView = require('ui/common/product/productDetail/Contessa/ProductDetailView');
	var ProductDetailMenuView = require('ui/common/product/productDetail/Contessa/ProductDetailMenuView');
	//construct UI
