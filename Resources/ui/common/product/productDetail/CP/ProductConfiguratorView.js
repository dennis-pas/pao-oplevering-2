...
function ProductConfiguratorView(Product){
	...
	*/
	...
	var array2 = [{name:'Zwart'},{name:'Wit'}];
	...
	textField1.addEventListener('click', function(e){
		var options = array1;
		var arrNumber = 1;
		var OptionView = require ('ui/common/product/productDetail/CP/OptionView');
		//var notav = nonarr[0];
	...
	/*var optionBox1 = TU.UI.createSimplePicker({
		title: 'choose',
		options: array1,
		cancel: array1.length - 1,
	});
	*/
