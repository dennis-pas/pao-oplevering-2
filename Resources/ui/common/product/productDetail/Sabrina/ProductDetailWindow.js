...
function ProductDetailWindow() {
	...
	var ProductDetailView = require('ui/common/product/productDetail/Sabrina/ProductDetailView');
	var ProductDetailMenuView = require('ui/common/product/productDetail/Sabrina/ProductDetailMenuView');
	//construct UI
