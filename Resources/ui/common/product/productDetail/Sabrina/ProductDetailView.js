...
function ProductDetailView(){
	...
	var ProductImageViewerView = require('ui/common/product/productDetail/Sabrina/ProductImageViewerView');

	var ProductDetailInfoView = require('ui/common/product/productDetail/Sabrina/ProductDetailInfoView');
	var ProductConfiguratorView = require('ui/common/product/productDetail/Sabrina/ProductConfiguratorView');
