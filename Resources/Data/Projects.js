...
Projects.prototype.importOverview = function() {
    var urlCheck = "http://apishop.planatoffice.nl/allProjects.aspx";
				...
				var xhrCheck = Ti.Network.createHTTPClient({
					    onload: function(e) {
							    ...
							    var items = xml.documentElement.getElementsByTagName("Project");
							   ...
							   //db.close();
							    ...
							    {
							    	db.execute('delete from Project where PID > -1;');
							    	for (var i=0;i<items.length;i++) {  	
											...
											for(var f =0; f< pictures.length;f++ )
											{
												...
												var test3= "test";
												var test4= "test";
												db.execute('INSERT INTO ProjectPictures (PIDFK, PictureUrl) VALUES(' + ID + ',"' + picture + '");');
											}
											
											var test1 = "test";
											var test2 = "test";
											db.execute('INSERT INTO Project (Title, OverviewPicture, Description) VALUES("' + titel + '","' + op  + '","' + description + '");');			  		
									    }
					 				    db.execute('UPDATE VersieProject set versie = ' + newVersion + ' where id = 1');
									    db.close();
							    }				       
								    },
								    onerror: function(e) {
